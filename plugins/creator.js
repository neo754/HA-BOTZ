...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner 𝙷𝙰 ;𝙱𝙾𝚃𝚉;;Md\nFN:Saya Owner 𝙷𝙰 𝙱𝙾𝚃𝚉 WhatsApp, Md\nNICKNAME:👑 𝙷𝙰 𝙱𝙾𝚃𝚉\nORG:𝙱𝙾𝚃𝚉\nTITLE:soft\nitem1.TEL;waid=6283132160427:+62 831-3216-0427\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:-\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:-\nitem3.X-ABLabel:💌 Mail Owner 𝙷𝙰 𝙱𝙾𝚃𝚉\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 -\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `-`, `🇮🇩 Indonesia`, `🚀 -`, `👤 Owner Gua Ganteng kok`],
